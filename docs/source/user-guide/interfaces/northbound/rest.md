...
The northbound REST interface of the Eclipse sensiNact Gateway is a user-facing API designed to fit naturally with the [core model](../../core/models/things/index.md). The implementation uses Jakarta RESTful Web Services via the OSGi Jakarta REST Whiteboard specification, and follows RESTful principles.
